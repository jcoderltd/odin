...
/**
 * In this example we use a {@link ComponentRegistrar} to register software components into an {@link InjectionContext}.
 * 
 * <p>
 * Once we add the components and initialize the {@link ComponentRegistrar} we can get managed instances as we do
 * normally via the {@link InjectionContext}.
 * 
