...
/**
 * Entry point for the {@link LoginComponent} example.
 * 
...
public class LoginComponentApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        registrar.addComponent(LoginComponent.class);
        registrar.initialize();

        LoginComponent loginComponent = registrar.injectionContext().get(LoginComponent.class);
        loginComponent.getLoginService().login(1);
        loginComponent.getLoginService().login(2);
        registrar.injectionContext().destroy();
    }
